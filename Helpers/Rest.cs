...
namespace pCombat.Helpers
{
	public static class Rest
	{
		...
		public static bool NeedRest()
		{
			...
			return !pCombat.MovementDisabled && !Me.InCombat && ((resource < 50 || Me.HealthPercent < 90)
		...
		{
			int resource = NormalizedResource();
			return !pCombat.MovementDisabled && !Me.InCombat && ((resource < 100 || Me.HealthPercent < 100)
